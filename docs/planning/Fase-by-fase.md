# Phase-by-Phase Plan — Monad Session Arena
...
# Phase 1 — Setup y contratos base
...
# Phase 2 — Ejecución con session key
...
# Phase 3 — Permisos, límites y primera integración completa
...
# Phase 4 — ERC-20 spend limit y UX final de permisos
...
# Phase 5 — Testing, seguridad y observabilidad
...
# Phase 6 — Deploy, ensayo y presentación
...
A partir de la mitad de la Phase 5:
...
Si una feature no está integrada al final de la Phase 4, se evalúa seriamente moverla a un alcance posterior.
...
- Probar hashing Solidity + TypeScript desde la Phase 1.
